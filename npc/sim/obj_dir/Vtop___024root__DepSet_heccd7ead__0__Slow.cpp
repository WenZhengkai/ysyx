...
void Vtop___024root____Vdpiimwrap_top__DOT__ysyx_core__DOT__ysyx_IFU__DOT__npc_nextPC_write_TOP(QData/*63:0*/ nextPC);
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__ysyx_core__DOT__PCSrc = (1U & 
                                               ((((IData)(vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__controls) 
                                                  >> 3U) 
                                                 & (IData)(vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__BranchHit)) 
                                                | (IData)(vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__controls)));
                             ...
                             >> 0x3fU)) : ((8U & (IData)(vlSelf->top__DOT__ysyx_core__DOT__Wmask))
                                            ...
                                            : ((2U 
                                                ...
                                                : (IData)(
                                                          (vlSelf->top__DOT__ysyx_core__DOT__ysyx_LSU__DOT__DPI_DataFromMem 
                                                           >> 7U))))));
    Vtop___024root____Vdpiimwrap_top__DOT__ysyx_core__DOT__ysyx_IFU__DOT__npc_nextPC_write_TOP(
                                                                                ((IData)(vlSelf->top__DOT__ysyx_core__DOT__PCSrc)
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__ysyx_core__DOT__PCSrc = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ysyx_core__DOT__tnpc = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__ALUCtrl = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__ysyx_core__DOT__src1 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__src2 = VL_RAND_RESET_Q(64);
    ...
    vlSelf->top__DOT__ysyx_core__DOT__DataFromMem = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__Wmask = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__ysyx_core__DOT__dw = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_LSU__DOT__Wmask64 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_LSU__DOT__DPI_DataFromMem = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_LSU__DOT__sig = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_IFU__DOT__DPI_DataFromMem = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__controls = VL_RAND_RESET_I(13);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__BranchHit = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_IDU__DOT__RtypeMul = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_ALU__DOT__ALURes_temp = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_ALU__DOT__divw_res = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_ALU__DOT__remw_res = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_ALU__DOT____VdfgTmp_h30e473f3__0 = 0;
    vlSelf->top__DOT__ysyx_core__DOT__ysyx_ALU__DOT____VdfgTmp_h30e9c121__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    vlSelf->__Vtask_top__DOT__ysyx_core__DOT__ysyx_LSU__DOT__npc_pmem_read__0__rdata = 0;
    vlSelf->__Vtask_top__DOT__ysyx_core__DOT__ysyx_IFU__DOT__npc_inst_read__2__rdata = 0;
