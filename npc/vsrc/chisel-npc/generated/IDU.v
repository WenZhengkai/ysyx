module IDU(
  ...
  wire  _ResSrc_T_1 = io_from_ifu_bits_inst[6:0] == 7'h3; // @[IDU.scala 167:20]
  wire  _ResSrc_T_3 = io_from_ifu_bits_inst[6:0] == 7'h73; // @[IDU.scala 168:20]
  ...
  wire [43:0] _ImmExt_T_10 = {_ImmExt_T_9, 12'h0}; // @[IDU.scala 176:65]
  ...
  assign io_to_isu_bits_cf_inst = io_from_ifu_bits_inst; // @[IDU.scala 148:8]
  assign io_to_isu_bits_cf_pc = io_from_ifu_bits_pc; // @[IDU.scala 148:8]
  assign io_to_isu_bits_cf_next_pc = io_from_ifu_bits_next_pc; // @[IDU.scala 148:8]
  assign io_to_isu_bits_cf_isBranch = io_from_ifu_bits_isBranch; // @[IDU.scala 148:8]
  assign io_to_isu_bits_ctrl_MemWrite = decodelist_0 == 3'h2; // @[IDU.scala 163:19]
  ...
  assign io_to_isu_bits_ctrl_fuType = {{1'd0}, decodelist_1}; // @[IDU.scala 157:17]
  assign io_to_isu_bits_ctrl_fuOpType = _decodelist_T_1 ? 7'h40 : _decodelist_T_206; // @[Lookup.scala 34:39]
  assign io_to_isu_bits_ctrl_rs1 = io_from_ifu_bits_inst[19:15]; // @[IDU.scala 143:21]
  assign io_to_isu_bits_ctrl_rs2 = io_from_ifu_bits_inst[24:20]; // @[IDU.scala 144:21]
  assign io_to_isu_bits_ctrl_rfWen = decodelist_0[2]; // @[IDU.scala 15:54]
  assign io_to_isu_bits_ctrl_rd = io_from_ifu_bits_inst[11:7]; // @[IDU.scala 142:20]
