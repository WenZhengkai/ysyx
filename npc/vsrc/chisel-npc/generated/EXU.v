module EXU(
  ...
  wire  _jalrBruRes_valid_T = io_from_isu_valid & io_from_isu_bits_cf_isBranch; // @[EXU.scala 229:34]
  wire  jalrBruRes_valid = io_from_isu_valid & io_from_isu_bits_cf_isBranch & io_from_isu_bits_cf_inst[6:0] == 7'h67; // @[EXU.scala 229:56]
  wire [31:0] _jalrBruRes_targetPc_T_1 = io_from_isu_bits_data_rfSrc1 + io_from_isu_bits_data_imm; // @[EXU.scala 231:48]
  wire [31:0] jalrBruRes_targetPc = _jalrBruRes_targetPc_T_1 & 32'hfffffffe; // @[EXU.scala 231:67]
  wire  typebBruRes_valid = _jalrBruRes_valid_T & io_from_isu_bits_cf_inst[6:0] == 7'h63; // @[EXU.scala 234:57]
  wire [31:0] pcIfBranch = io_from_isu_bits_cf_pc + io_from_isu_bits_data_imm; // @[EXU.scala 235:35]
  wire [31:0] _typebBruRes_targetPc_T_1 = io_from_isu_bits_cf_pc + 32'h4; // @[EXU.scala 236:73]
  wire [31:0] typebBruRes_targetPc = alu0_io_taken ? pcIfBranch : _typebBruRes_targetPc_T_1; // @[EXU.scala 236:32]
  wire  csrBruRes_valid = io_from_isu_valid & csr0_io_jmp; // @[EXU.scala 239:33]
  wire [31:0] csrBruRes_targetPc = csr0_io_out_bits; // @[EXU.scala 238:25 240:24]
  ...
  wire  PredictError = bruRes_targetPc != io_from_isu_bits_cf_next_pc; // @[EXU.scala 254:40]
  wire  _T = io_redirect_valid & io_from_isu_valid; // @[EXU.scala 272:48]
  ...
  assign io_to_wbu_bits_cf_next_pc = bruRes_valid ? bruRes_targetPc : io_from_isu_bits_cf_next_pc; // @[EXU.scala 258:31]
  ...
  assign io_to_wbu_bits_data_Alu0Res_bits = alu0_io_out_bits; // @[EXU.scala 266:32]
  ...
  assign io_redirect_valid = io_from_isu_valid & bruRes_valid & PredictError; // @[EXU.scala 255:51]
