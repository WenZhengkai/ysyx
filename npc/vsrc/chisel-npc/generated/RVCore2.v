...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [4:0] isu_io_to_exu_bits_ctrl_rs1; // @[RVCore.scala 98:19]
  wire [4:0] isu_io_to_exu_bits_ctrl_rs2; // @[RVCore.scala 98:19]
  ...
  wire  regfile_clk; // @[RVCore.scala 133:23]
  wire [4:0] regfile_rs1; // @[RVCore.scala 133:23]
  wire [4:0] regfile_rs2; // @[RVCore.scala 133:23]
  wire [4:0] regfile_rd; // @[RVCore.scala 133:23]
  wire [31:0] regfile_dest; // @[RVCore.scala 133:23]
  wire  regfile_RegWrite; // @[RVCore.scala 133:23]
  wire [31:0] regfile_src1; // @[RVCore.scala 133:23]
  wire [31:0] regfile_src2; // @[RVCore.scala 133:23]
  ...
  reg  io_commit_valid_REG; // @[RVCore.scala 126:29]
  reg [31:0] io_commit_pc_REG; // @[RVCore.scala 128:26]
  reg [31:0] io_commit_next_pc_REG; // @[RVCore.scala 129:31]
  reg [31:0] io_commit_inst_REG; // @[RVCore.scala 130:28]
  IFU ifu ( // @[RVCore.scala 96:19]
    .clock(ifu_clock),
    .reset(ifu_reset),
    .io_inst(ifu_io_inst),
  ...
  ysyx_23060228_RegFile_BlackBox #(.DATA_WIDTH(32)) regfile ( // @[RVCore.scala 133:23]
    .clk(regfile_clk),
    .rs1(regfile_rs1),
    .rs2(regfile_rs2),
    .rd(regfile_rd),
  ...
  assign io_commit_valid = io_commit_valid_REG; // @[RVCore.scala 126:19]
  assign io_commit_pc = io_commit_pc_REG; // @[RVCore.scala 128:16]
  assign io_commit_next_pc = io_commit_next_pc_REG; // @[RVCore.scala 129:21]
  assign io_commit_inst = io_commit_inst_REG; // @[RVCore.scala 130:18]
  ...
  assign ifu_io_redirect_target = exu_io_redirect_target; // @[RVCore.scala 118:19]
  assign ifu_io_redirect_valid = exu_io_redirect_valid; // @[RVCore.scala 118:19]
  ...
  assign isu_io_wb_rd = wbu_io_to_reg_bits_rd; // @[RVCore.scala 120:13]
  assign isu_io_wb_RegWrite = wbu_io_to_reg_bits_RegWrite; // @[RVCore.scala 120:13]
  assign isu_io_from_reg_rfSrc1 = regfile_src1; // @[ISU.scala 79:32]
  assign isu_io_from_reg_rfSrc2 = regfile_src2; // @[ISU.scala 80:32]
  ...
  assign regfile_clk = clock; // @[RVCore.scala 134:18]
  assign regfile_rs1 = isu_io_to_exu_bits_ctrl_rs1; // @[RVCore.scala 136:18]
  assign regfile_rs2 = isu_io_to_exu_bits_ctrl_rs2; // @[RVCore.scala 137:18]
  assign regfile_rd = wbu_io_to_reg_bits_rd; // @[RVCore.scala 138:19]
  assign regfile_dest = wbu_io_to_reg_bits_Res; // @[RVCore.scala 139:19]
  assign regfile_RegWrite = wbu_io_to_reg_bits_RegWrite; // @[RVCore.scala 140:23]
  always @(posedge clock) begin
    ...
    if (reset) begin // @[RVCore.scala 126:29]
      io_commit_valid_REG <= 1'h0; // @[RVCore.scala 126:29]
    end else begin
      io_commit_valid_REG <= wbu_io_to_reg_valid; // @[RVCore.scala 126:29]
    end
    io_commit_pc_REG <= wbu_io_to_commit_pc; // @[RVCore.scala 128:26]
    io_commit_next_pc_REG <= wbu_io_to_commit_next_pc; // @[RVCore.scala 129:31]
    io_commit_inst_REG <= wbu_io_to_commit_inst; // @[RVCore.scala 130:28]
  end
